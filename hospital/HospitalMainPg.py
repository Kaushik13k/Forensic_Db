...
from HospitalCaseList import HospitalCaseList
from HospitalDoctorList import docList
from HospitalDoctorRegistration import DoctorRegistrationPage


class HospitalMainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dtrReg.clicked.connect(self.DocRegister)
        self.caseList.clicked.connect(self.casList)
        self.docList.clicked.connect(self.docLis)

    def DocRegister(self):
        self.MainWindow = QtWidgets.QMainWindow()
        self.ui = DoctorRegistrationPage()
        self.ui.setupUi(self.MainWindow)
        self.MainWindow.show()

    def casList(self):
        self.MainWindow = QtWidgets.QMainWindow()
        self.ui = HospitalCaseList()
        self.ui.setupUi(self.MainWindow)
        self.MainWindow.show()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dtrReg.setText(_translate("MainWindow", "DOCTOR REGISTRATION"))
        self.caseReg.setText(_translate("MainWindow", "CASE REGISTRATION"))
        self.caseList.setText(_translate("MainWindow", "CASE LIST"))
        self.docList.setText(_translate("MainWindow", "DOCTOR LIST"))
