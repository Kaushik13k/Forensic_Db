...
from StationMainPg import PoliceMainWindow
from admin.global_variables import GlobalStatic


class StationUiMainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.clicked.connect(self.LoginStation)

    def mainPage(self):
        self.MainWindow = QtWidgets.QMainWindow()
        self.ui = PoliceMainWindow()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "STATION LOGIN"))
    ...
    def LoginStation(self):
        ...
        if username == "" or password == "":
            ...
            try:
                ...
                cur = conn.cursor()
                cur.execute("select * from police_station where pst_email=? and pst_password=?",
                            (username, password))
                police_station_tuple = cur.fetchone()
                print(police_station_tuple)

                GlobalStatic.set_police_station_id(police_station_tuple[0])
                if police_station_tuple == None:
