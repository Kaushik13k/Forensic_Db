...
class PoliceList(object):
    def __init__(self):
        super().__init__()

        self.__all_stpol_list_ = []
...
"")
        ...
        self.dlUpdate.setGeometry(QtCore.QRect(60, 680, 101, 41))
        font = QtGui.QFont()
...
"")
        ...
        self.dlDelete.setGeometry(QtCore.QRect(200, 680, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "POLICE LIST"))
        ...
        self.dl_id.setText(_translate("MainWindow", "  Police_id"))
        ...
        self.dl_comboBox.setItemText(0, _translate("MainWindow", "id"))
        self.dl_comboBox.setItemText(1, _translate("MainWindow", "name"))
        self.dl_comboBox.setItemText(2, _translate("MainWindow", "phone"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Police_id"))
    ...
    def DoctorLoadData(self):
            ...
            cur = conn.cursor()
            cur.execute("select p_id,p_name,p_age,p_exp,p_place,p_phone,p_email from police where pst_id=?;", (GlobalStatic.police_station_id))
            rows = cur.fetchall()
            self.tableWidget.setRowCount(50)
            tableindex = 0

            self.__all_stpol_list_ = rows
    ...
    def _cell_clicked(self, row_index, column_index):
            ...
            row = self.__all_stpol_list_[row_index]
