...
from DoctorCaseList import DocCaseList
...
class DocUiMainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "DOCTORS LOGIN"))
    ...
    def LoginDoc(self):
        ...
        if username == "" or password == "":
            ...
            try:
                ...
                cur = conn.cursor()
                cur.execute("select * from doctor where d_email=? and d_password=?",
                            (username, password))
                doctor_tuple = cur.fetchone()
                print(doctor_tuple)

                GlobalStatic.set_doctor_id(doctor_tuple[0])
                if doctor_tuple == None:
                    msg.setIcon(QMessageBox.Information)
